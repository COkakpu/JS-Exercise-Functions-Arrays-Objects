...
function getCarInfoByIndex(inventory, index) {
  ...
  return `The is a ${theCar.car_make} ${theCar.car_model}`
}
...
function getLastCarInfo(newInventory) {
  var lastCar = newInventory.pop();
  return `The is a ${lastCar.car_make} ${lastCar.car_model}`;
}
console.log(getLastCarInfo(newInventory));
...
*/
function getModelYears(newInventory) {
  for (var index = 0; index < newInventory.length; index++)
    console.log(newInventory[index].car_year);
}
getModelYears(newInventory);
